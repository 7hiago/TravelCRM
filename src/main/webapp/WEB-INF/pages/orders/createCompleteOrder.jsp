...
<form:form action="saveCreatedCompleteOrder" method="post" modelAttribute="createOrderDTO">
    <table>
    <%--row 1--%>
        <tr>
        <%--Tour column--%>
...
<%--            <td><form:input path="accounting.touroperatorPaid"/></td>--%>
            <td></td>
            <td></td>
        <%--Data column--%>
            <td></td>
    ...
    <%--row 7--%>
        ...
        <%--Manager column--%>
<%--            <td>Profit:</td>--%>
<%--            <td><form:input path="accounting.profit"/></td>--%>
            <td></td>
            <td></td>
        <%--Data column--%>
            <td></td>
